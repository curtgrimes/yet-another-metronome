...
import MetronomeRectangle from './Metronome/MetronomeRectangle.vue';

const metronome = defineModel<Metronome>();
</script>

<template>
    <MetronomeRectangle v-if="metronome?.style.id === 'rectangle'" v-model="metronome" />
    <div v-else
        ...
        <UIcon name="i-mingcute-alert-line" class="text-3xl" />
